...
<div class="courses_box1">
    <div class="container">
	   	...
	   	<div class="col-md-6">
	   	  	<img src="template/images/event.jpg" class="img-responsive" alt=""/>
	   	</div>
...
<div class="bg_1">
    <div class="container">
		...
		<div class="col-md-3 team_grid">
			<div class="team">
                <img src="template/images/team1.jpg" class="img-responsive" alt=""/>
                <div class="team_box">
        ...
        <div class="col-md-3 team_grid">
			<div class="team">
                <img src="template/images/team4.jpg" class="img-responsive" alt=""/>
                <div class="team_box">
                    <h3>slightly believable</h3>
                    <p>Economics</p>
                    <ul class="team-socials">
        ...
        <div class="col-md-3 team_grid">
			<div class="team">
                <img src="template/images/team2.jpg" class="img-responsive" alt=""/>
                   <div class="team_box">
                     <h3>slightly believable</h3>
                     <p>Economics</p>
                     <ul class="team-socials">
        ...
        <div class="col-md-3 team_grid">
			<div class="team">
                <img src="template/images/team3.jpg" class="img-responsive" alt=""/>
                <div class="team_box">
                    <h3>slightly believable</h3>
                    <p>Economics</p>
                    <ul class="team-socials">
