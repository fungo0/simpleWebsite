        ...
        <ul class="nav navbar-top-links navbar-right">
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    <li>
                        <a href="{{ url('/notifications') }}">
                            <div>
                                <i class="fa fa-envelope-o fa-fw"></i> Notifications 
                                @if ( count(Auth::user()->unreadNotifications) != 0 )
                                    ({{ count(Auth::user()->unreadNotifications) }}) 
                                    <span class="pull-right text-muted small">(new)</span>
                                @endif
                            </div>
                        </a>
                    </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{ url('/logout2') }}"><i class="fa fa-sign-out"></i><span>Logout</span></a></li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
            <!-- /.dropdown -->
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li {{ (Request::is('*users') ? 'class="active"' : '') }}>
                        <a href="{{ url ('users') }}"><i class="fa fa-list fa-fw"></i> User Management</a>
                    </li>
                    <li >
                        <a href="#"><i class="fa fa-file-text-o fa-fw"></i> Posts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li {{ (Request::is('*posts') ? 'class="active"' : '') }}>
                                <a href="{{ url ('posts') }}"><i class="fa fa-database fa-fw"></i> Edit Article</a>
                            </li>
                            <li {{ (Request::is('*posts.create') ? 'class="active"' : '') }}>
                                <a href="{{ route('posts.create') }}"><i class="fa fa-folder-open fa-fw"></i> New Article</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li {{ (Request::is('*courses.create') ? 'class="active"' : '') }}>
                        <a href="{{ route('courses.create') }}"><i class="fa fa-folder-open fa-fw"></i> New Course</a>
                    </li>
                
                    <li {{ (Request::is('*events.create') ? 'class="active"' : '') }}>
                        <a href="{{ route('events.create') }}"><i class="fa fa-folder-open fa-fw"></i> New Event</a>
                    </li>
